"""Settings/config for the constitutional app backend
"""


TESTING_DOCUMENTS_INPUT_PATH = r'testing_documents_input'
TESTING_DOCUMENTS_OUTPUT_PATH = r'testing_documents_output'
